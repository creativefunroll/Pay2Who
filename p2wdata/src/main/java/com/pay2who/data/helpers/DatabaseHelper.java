...
public class DatabaseHelper {
    ...
    private IServiceReference<Firebase> source;
    ...
    public  Message<String> login(LoginInfo info) {
    ...
    public Message<Boolean> changePassword(ChangePasswordInfo info) {
    ...
    public Message<Boolean> saveUserDetails(SignupInfo info) {
        String child = "users";
